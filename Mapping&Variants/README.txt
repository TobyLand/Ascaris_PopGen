# Population structure of Ascaris lumbricoides infecting 
...
parallel "awk '{print \$1,\$2,\$3,\$4,FILENAME}' {1}.cov | sed 's/.cov//g' | sed 's/SM_V7_//g' | sed 's/ZW/Z/g' > {1}.renamed.cov" :::: <(cat ${WORKING_DIR}/00_METADATA/suppdata.txt | grep "gz")
...
mv merged_all_samples.filtered.vcf.FL4.SNPEFF.vcf ${WORKING_DIR}/06_ANALYSIS/FREEZE/As_POPGEN.snpeff.vcf
mv merged_all_samples.filtered.vcf.FL4.vcf ${WORKING_DIR}/06_ANALYSIS/FREEZE/As_POPGEN.vcf
mv merged_all_samples.allsites.198.vcf ${WORKING_DIR}/06_ANALYSIS/FREEZE/As_POPGEN.allsites.vcf
```
